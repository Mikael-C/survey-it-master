    ...
    try {
        if (successObject.data) {
            ...
            if (successObject.data.message) {
                ...
                shouldDispatchAlert && store.dispatch(setAlertAction({type:'success', message:successObject.data.message}));
                ...
                shouldDispatchAlert && store.dispatch(setAlertAction({type:'success', message:'Success'}));
            }
