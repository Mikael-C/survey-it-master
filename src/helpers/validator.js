...
const validator = {
    ...
    maxSize:(value, maximum)=>{ value = value?value:'0'; return value.length < maximum ? true :false; },
    minSize:(value, minimum)=>{ value = value?value:'0'; return value.length > minimum ? true :false; },
