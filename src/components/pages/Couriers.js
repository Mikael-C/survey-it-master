...
import { getCouriersAction } from '../../redux/actions/courierActions';
import Table from '../pages/Table'

export default function Couriers(){

    const dispatch = useDispatch();
    const userState = useSelector(state => state.couriers);

    React.useEffect(() => {
        dispatch(getCouriersAction({properties:1}));
    }, [dispatch]);

    const renderCouriers = (data) => {
                ...
                <div className="card shadow mb-4">
                    ...
                    <div className="table-responsive">
                        ...
                        <tbody>
                            ...
                            {renderCouriers(userState.couriers)}
                        </tbody>
                        </table>
                    </div>
                    </div>
